...
|Для использования функции _Интеллектуальный поиск_ требуется дополнительная опция лицензии, см. документацию модуля "xref:dev@webclient:ROOT:requirements-license.adoc[]".
|===
