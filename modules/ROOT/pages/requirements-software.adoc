...
* https://www.cryptopro.ru/products/csp[КриптоПро CSP {csp-v}] для работы xref:dev@engineer:ROOT:authorization-extensions.adoc#esia[расширения аутентификации ЕСИА].
