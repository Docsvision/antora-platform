...
[loweralpha]
.. Выполните [.ph .filepath]`"C:\Program Files\Elastic\Elasticsearch\bin\elasticsearch-plugin.bat" install file:///C:/elasticplugins/elasticsearch-analysis-icu-7.9.0.zip` ([.ph .filepath]`C:/elasticplugins/` заменить на путь загрузки компонента).
.. Выполните [.ph .filepath]`"C:\Program Files\Elastic\Elasticsearch\bin\elasticsearch-plugin.bat" install file:///C:/elasticplugins/ingest-attachment-7.9.0.zip` ([.ph .filepath]`C:/elasticplugins/` заменить на путь загрузки компонента).
