...
Настройка модуля может выполняться в конфигурационном файле модуля, `appsettings.json` или в интерфейсе {of-mc}, не требующем работы с файлами формата .json. Подробнее о настройке модуля в {of-mc} см. <<mancons,ниже>>.
