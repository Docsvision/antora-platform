...
- При выполнении отчета с признаком "Только чтение".
...
[TIP]
====
Полный список требований приведен на сайте https://docs.microsoft.com/ru-ru/sql/database-engine/availability-groups/windows/prereqs-restrictions-recommendations-always-on-availability?view=sql-server-2017#PrerequisitesSI[Microsoft].
====
...
- _Название-БД-{dv}_Archive_ -- для архивных данных.
- _Название-БД-{dv}_Metadata_ -- для системных данных.
- _Название-БД-{dv}_Log_ -- для журналов работы.
****
+
