...
.. Для работы
// xref:dev@platform:ROOT:requirements-server-accounts.adoc[сервера {dv}], xref:dev@platform::ROOT:requirements-server-accounts.adoc[сервера {dv}],
сервиса xref:dev@platform:ROOT:requirements-full-text-account.adoc[полнотекстового поиска].
// и
// xref:dev@platform:ROOT:requirements-file-service-accounts.adoc[файлового сервиса]
