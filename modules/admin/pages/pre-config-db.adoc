...
.. Для работы
// xref:6.1@platform:ROOT:requirements-server-account.adoc[сервера {dv}], xref:6.1@platform::ROOT:requirements-server-account.adoc[сервера {dv}],
сервиса xref:6.1@platform:ROOT:requirements-full-text-account.adoc[полнотекстового поиска].
// и
// xref:6.1@platform:ROOT:requirements-file-service-account.adoc[файлового сервиса]
