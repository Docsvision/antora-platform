...
ifndef::installguide[]
xref:platform:admin:requirementsServerAccount.adoc[сервера {dv}]
endif::[]
, сервиса
ifdef::platform[]
...
ifndef::installguide[]
xref:platform:admin:requirementsFullTextAccount.adoc[полнотекстового поиска].
endif::[]
и
ifdef::platform[]
...
ifndef::installguide[]
xref:platform:admin:requirementsFileServiceAccount.adoc[файлового сервиса].
endif::[]
+
