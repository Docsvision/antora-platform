...
ifndef::installguide[]
xref:platfrom:ROOT:requirementsServerAccount.adoc[сервера {dv}],
endif::[]
сервиса
ifdef::platform[]
...
ifndef::installguide[]
xref:platfrom:ROOT:requirementsFullTextAccount.adoc[полнотекстового поиска]
endif::[]
и
ifdef::platform[]
...
ifndef::installguide[]
xref:platfrom:ROOT:requirementsFileServiceAccount.adoc[файлового сервиса].
endif::[]
+
