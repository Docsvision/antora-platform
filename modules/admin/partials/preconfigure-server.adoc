...
ifndef::installguide[]
xref:5.5.5@platform:ROOT:requirements-server-account.adoc[сервера {dv}],
endif::[]
сервиса
ifdef::platform[]
...
ifndef::installguide[]
xref:5.5.5@platform:ROOT:requirements-full-text-account.adoc[полнотекстового поиска]
endif::[]
и
ifdef::platform[]
...
ifndef::installguide[]
xref:5.5.5@platform:ROOT:requirements-file-service-account.adoc[файлового сервиса].
endif::[]
+
