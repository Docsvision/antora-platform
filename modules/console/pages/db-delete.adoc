...
****
Начиная с модуля {pl} версии {pl-cu5}, удалить БД из системы {dv} администратор может двумя способами:

* С помощью программы {cns}, настройка описана ниже.
* Из интерфейса {of-mc}: "xref:dev@mgmtconsole:servers:db-delete.adoc[]".
****
