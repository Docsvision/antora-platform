...
В данный журнал сохраняется информация об ошибках работы {of-fs} {dv}, а также информационные сообщения (если включено).
...
Журналирование с использованием NLog по умолчанию работает, когда в конфигурационном файле {config-fs} указаны настройки NLog. Если настройки в конфигурационном файле не указаны, журналирование будет работать по прежнему принципу.

Пути к журналам, уровень и режим журналирования настраиваются в конфигурационном файле по адресу {config-fs}.
