...
Протоколирование запросов сервера приложений настраивается в конфигурационном файле модуля по адресу {config-pl}, за настройку отвечает параметр `W3CLogging`:
