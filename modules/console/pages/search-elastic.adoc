...
+
* Для ОС Windows загрузите инсталлятор https://www.elastic.co/downloads/past-releases/elasticsearch-{es-link}[с сайта {es}] и установите на компьютер. При установке не изменяйте настройки по умолчанию.
+
