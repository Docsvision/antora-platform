:with-console: yes
:with-config: no
:do-what: способы настройки хранилищ файлов
:link: "xref:6.2@mgmtconsole:servers:db-storage-samples.adoc[]"
:cns-section: "menu:Базы данных[Настройка > Внешние хранилища]"
