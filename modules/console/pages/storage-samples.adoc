...
****
Начиная с модуля {pl} версии {pl-cu5}, примеры настройки хранилищ файлов приведены в разделах документации:

* Программы {cns}, см. подробнее ниже
* {of-mc}, см. подробнее "xref:dev@mgmtconsole:servers:db-storage-samples.adoc[]"
****
