...
NOTE: Для использования расширений авторизации потребуется дополнительная опция лицензии. См. подробнее требования в документации модуля {wc} "xref:webclient:ROOT:requirements-license.adoc[]".
